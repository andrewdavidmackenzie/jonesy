...
- Always run `make test` (not just `cargo test`) before pushing, since the Makefile
  builds nested workspaces (like `examples/workspace_test`) that aren't part of the
  main workspace.
